...
<body class = "alert-warning">
	<nav class  = "navbar navbar-inverse">
		<div class = "container-fluid">
			<div class = "navbar-header">
				<a class = "navbar-brand">Church Membership System</a>
			</div>
			...
			<div class = "row">
				...
				<div class = "col-md-4">
					...
					<form method = "POST">
						...
						<!--this is for the addition phase-->
					
						
					<div class = "form-group">
							<label>residential_address</label>
							<input id = "residential_address" type = "text" value = "<?php echo $acc_fetch['residential_address'] ?>" class = "form-control" />
							
						</div>
						<div class = "form-group">
							<label>birthday</label>
							<input id = "birthday" type = "date" value = "<?php echo $acc_fetch['birthday'] ?>" class = "form-control" />
							
						</div>
						<div class = "form-group">
							<label>cell_number</label>
							<input id = "cell_number" type = "text" value = "<?php echo $acc_fetch['cell_number'] ?>" class = "form-control" />
							
						</div>
						<div class = "form-group">
							<label>email_address</label>
							<input  id = "email_address" type = "email" value = "<?php echo $acc_fetch['email_address'] ?>" class = "form-control" />
	...
	<label class = "pull-right">&copy; <?php echo date('Y', strtotime('+8 HOURS')) ?> Developed By: <b>Lubunda Musonda</b></label>
	</footer>
</body>
