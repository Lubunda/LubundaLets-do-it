...
// Member Registration
	$('#save_member').click(function(){
		...
		if($firstname == "" || $lastname == "" || $residential == "" || $birthday == "" || $cell_number == "" || $email_address == ""){
			$error.appendTo('#loading');
		}else{
			$load_status.appendTo('#loading');
			setTimeout(function(){
				$.post('mem_validator.php', {firstname: $firstname, lastname: $lastname ,residential_address: $residential_address,birthday: $birthday,cell_number: $cell_number,email_address: $email_address},
					function(result){
						if(result == "Success"){
							...
							$.ajax({
								type: 'POST',
								url: 'save_member.php',
								data: {firstname: $firstname, lastname: $lastname,residential_address: $residential_address,birthday: $birthday,cell_number: $cell_number,email_address: $email_address},
								success: function(){
...
$('#mem_edit').click(function(){
		...
		$cell_number = $('#cell_number').val();
		$email_address = $('#email_address').val();
		if($firstname == "" || $lastname == "" || $residential_address == "" || $birthday == "" || $cell_number == "" || $email_address == ""){
			$error.appendTo('#loading');
		}else{
			$load_status.appendTo('#loading');
			setTimeout(function(){
				$.post('mem_validator.php', {memId : $mem_id, firstname: $firstname,
											lastname: $lastname ,
