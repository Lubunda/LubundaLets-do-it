...
while ($f_query = $query->fetch_array()) {
    ?>
						<tr>
							...
							<td><?php echo $f_query['residential_address'] ?></td>
							<td><?php echo $f_query['birthday'] ?></td>
							<td><?php echo $f_query['cell_number'] ?></td>
							<td><?php echo $f_query['email_address'] ?></td>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method = "POST" enctype = "multipart/form-data">
					...
					<!--Xanny Family test-->
					<div class = "form-group">
						<label>residebtial_address</label>
